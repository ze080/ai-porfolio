...
type ValueKeyframe<T extends string | number = string | number> = T;
type UnresolvedValueKeyframe<T extends string | number = string | number> = ValueKeyframe<T> | null;
...
type Transition<V = any> = StyleTransitions & SVGPathTransitions & SVGForcedAttrTransitions & SVGTransitions & VariableTransitions & ValueAnimationTransition<V> & {
    default?: ValueTransition;
    layout?: ValueTransition;
};
type DynamicOption<T> = (i: number, total: number) => T;
interface AnimationOptions extends Omit<Transition, "delay"> {
 ...
 * @public
 */
type TargetAndTransition = DOMKeyframesDefinition & {
 ...
 * @public
 */
declare function springValue<T extends string | number>(source: T | MotionValue<T>, options?: SpringOptions): MotionValue<T>;
declare function attachSpring<T extends string | number>(value: MotionValue<T>, source: T | MotionValue<T>, options?: SpringOptions): VoidFunction | undefined;
